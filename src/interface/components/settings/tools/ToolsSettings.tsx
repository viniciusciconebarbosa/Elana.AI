        ...
        <div className="space-y-6">
            <Card className="border-border">
                <CardHeader>
                    ...
                    <CardDescription>
                        Configure as chaves de acesso para ferramentas externas usadas pela inteligência artificial.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <SettingField
                            ...
                            description="Chave de API para a ferramenta de busca na internet."
                        ...
                        <div className="p-3 rounded-lg bg-secondary/30 border border-border">
                            <p className="text-xs text-muted-foreground leading-relaxed">
                                <strong className="text-foreground">Como obter sua chave:</strong><br/>
                                1. Acesse <a href="https://tavily.com" target="_blank" rel="noopener noreferrer" className="text-primary underline">tavily.com</a><br/>
                                2. Crie uma conta gratuita (Free Tier).<br/>
                                3. Vá no painel e copie sua API Key que começa com <code className="font-mono text-primary">tvly-</code>.
                            </p>
                        </div>
                    </div>
